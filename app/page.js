...
export default function Home() {
      ...
      <section className={`py-28 px-4 md:px-16 bg-[#1A0A00] text-white transition-all duration-700 delay-200 ${scrolled ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Text content */}
  <div>
  <div className="mb-2 text-[#D4A017] font-semibold uppercase tracking-widest text-sm">Tentang Pemilihan</div>
  <h2 className="text-4xl md:text-5xl font-bold mb-8 relative">
    ...
    Jadilah Bagian <span className="text-[#D4A017]">Duta Budaya</span> Jawa Timur
  </h2>
  <p className="text-lg md:text-xl leading-relaxed text-[#B0A18F] mb-6">
    Pemilihan Duta Budaya Jawa Timur adalah ajang bergengsi untuk mencari generasi muda terbaik yang siap menjadi wajah pelestarian dan promosi budaya di tingkat daerah, nasional, hingga internasional.
  </p>
  <p className="text-lg md:text-xl leading-relaxed text-[#B0A18F] mb-8">
    Bergabunglah bersama kami, tunjukkan bakat, pengetahuan, dan dedikasimu untuk budaya Jawa Timur. Jadilah inspirasi dan agen perubahan melalui program Duta Budaya!
  </p>
 ...
 <section className="py-20 px-4 md:px-16 bg-[#3A2C1A]">
  <div className="max-w-6xl mx-auto">
    <div className="text-center mb-16">
      <div className="inline-block mb-4 text-[#D4A017] font-semibold uppercase tracking-widest text-sm">Pemilihan</div>
      <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white">
         Narapati Kencana <span className="text-[#D4A017]"> Duta Budaya</span> Jawa Timur
      </h2>
      ...
      {[
        {
          ...
          description: "Baca dan pahami seluruh syarat serta ketentuan untuk mengikuti ajang Duta Budaya Jawa Timur.",
          icon: "📑",
          color: "from-[#800020] to-[#5A0015]"
        },
        {
          title: "Golden Ticket",
          description: "Kesempatan istimewa bagi peserta terpilih untuk langsung melaju ke tahap berikutnya.",
          icon: "🎫",
          color: "from-[#D4A017] to-[#B8860B]"
        },
        {
          title: "Pemilihan (Daftar)",
          description: "Segera daftarkan dirimu dan jadilah bagian dari perjalanan budaya Jawa Timur.",
          icon: "📝",
      ...
      <section className="py-20 px-4 md:px-16 bg-gradient-to-r from-[#1A0A00] to-[#3A2C1A] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">
            Daftarkan diri  <span className="text-[#D4A017]">anda sekarang juga</span>!
          </h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
       <a
  href="https://linktr.ee/DutaBudayaJawaTimur2025?utm_source=linktree_admin_share"
  target="_blank"
