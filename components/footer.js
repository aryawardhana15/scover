        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <address className="not-italic space-y-4 text-[#B0A18F]">
              <div className="flex">
                <svg className="w-5 h-5 mr-3 mt-0.5 text-[#800020] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:dutabudayajawatimur@gmail.com" className="hover:text-[#D4A017] transition-colors duration-300 break-all">
                  dutabudayajawatimur@gmail.com
                </a>
              </div>
              <div className="flex">
                <svg className="w-5 h-5 mr-3 mt-0.5 text-[#800020] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="tel:+6285708829751" className="hover:text-[#D4A017] transition-colors duration-300">
                  +62 857 0882 9751 (Mbak Najua)
                </a>
              </div>
              <div className="flex">
                <svg className="w-5 h-5 mr-3 mt-0.5 text-[#800020] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="tel:+6281336539976" className="hover:text-[#D4A017] transition-colors duration-300">
                  +62 813 3653 9976 (Mbak Virdha )
                </a>
              </div>
              <div className="flex">
                <svg className="w-5 h-5 mr-3 mt-0.5 text-[#800020] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
